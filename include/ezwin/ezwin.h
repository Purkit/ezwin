...
//// * EZ PUBLIC API * ////
EZAPI int EzInitializePlatform();
...
EZAPI bool WindowShouldClose(EzWindow *window);
...
// Input Handling API:
EZAPI bool GetKeyState(EzWindow *window, EzKeyCode key);
...
EZAPI void SetWaylandRenderSignalCallback(EzWindow *window, fp_render callback);
